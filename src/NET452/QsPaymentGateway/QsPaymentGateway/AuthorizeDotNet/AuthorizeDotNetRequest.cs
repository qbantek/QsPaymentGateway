...
namespace QsPaymentGateway.AuthorizeDotNet
{
    public class AuthorizeDotNetRequest : GatewayRequest
    {
                                                 ...
                                                 decimal amount)
        {
            ...
            Queue(AuthorizeDotNetApi.Amount, amount.ToString(CultureInfo.InvariantCulture));
            return this;
        }
        ...
        public override GatewayRequest Settle(string transactionId, decimal amount)
        {
            ...
            if (amount > 0) Queue(AuthorizeDotNetApi.Amount, amount.ToString(CultureInfo.InvariantCulture));
            return this;
        }
